...
export default function SingleUsersCards({
  ...
  return (
    <div className="col-span-4 flex justify-end p-4 col-span-5">
      <div className={cn(uiTokens.panel, "max-w-xl w-full p-8")}>
          ...
          <>
            <div className="mb-6 border-l-4 border-blue-500 pl-6">
              ...
              <p className="text-gray-600">
                {formatUserDisplayEmail(n?.email)}
              </p>
            </div>
            <div className="mb-6 grid grid-cols-1 gap-4">
              ...
              <div className="rounded-lg bg-purple-50 p-4">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <p className="text-sm border p-2 bg-white">{users?.tenant}</p>
                </div>
              </div>
            </div>
          </>
        ...
        <div className="flex border-t items-baseline">
          <DeleteButton
            token={token}
            n={users}
            navigate={navigate}
