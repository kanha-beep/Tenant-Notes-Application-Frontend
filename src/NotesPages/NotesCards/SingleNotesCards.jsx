...
export default function SingleNotesCards({
  ...
  return (
    ...
    >
      <div
        className={`w-full p-4 bg-white/80 rounded-lg h-full ${
          isOverdue ? "border-red-500 ring-2 ring-red-200" : ""
        }`}
      >
        {isOverdue ? (
          <div className="rounded-xl bg-red-50 px-4 py-3 text-sm font-semibold mb-4 text-red-700">
        ...
        <div className="mb-4 rounded-xl bg-slate-50 p-4">
          <h5 className="mb-3 text-lg font-bold border-b-2 text-slate-700">
            Content
          </h5>
        ...
        <div className="mb-4 grid gap-3 md:grid-cols-2 bg-yellow-200">
        ...
        {showUserFeedbackForm ? (
          <div className="mb-4 rounded-xl border border-slate-200 bg-yellow-800 p-4">
        ...
        <div className="flex flex-wrap items-center gap-2 border-t border-slate-200 pt-3 fixed bottom-[5rem]">
          <DeleteButton
            token={token}
            n={n}
            navigate={navigate}
